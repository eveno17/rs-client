...
public final class ArchiveDisk {
   ...
   static void method5318(int var0) {
      if(var0 == -3) {
         ...
         PlayerType.method3939("Erebor has been updated!", "Please reload this page.", "");
      } else if(var0 == 7) {
         ...
         try {
            ArchiveDiskActionHandler.method4341("https://www.erebor.ee/forums/member.php?action=register", true, false);//Is this the only custom login msg?
         } catch (Exception e) {
            e.printStackTrace();
         }
      } else {
