...
public class WorldMapRegion {
   ...
   public static File method337(String var0, String var1, int var2) {
      ...
      JagexCache.JagexCache_locationFile = new File(JagexCache.userHomeDirectory, "misthalin_cl_" + var0 + "_" + var1 + var3 + ".dat");
      String var4 = null;
      String var5 = null;
      boolean var6 = false;
      Buffer var8;
      ...
      if(var4 == null) {
         var4 = JagexCache.userHomeDirectory + File.separatorChar + "mist" + var3 + File.separatorChar + var0 + File.separatorChar + var1 + File.separatorChar;
         var6 = true;
      }
